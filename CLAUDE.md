...
**YOU ARE IN: `defender/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/defender/` (rig root) or other directories
...
**Your mail address:** `defender/polecats/obsidian`
**Your rig:** defender
**Your Witness:** `defender/witness`
...
| Ask Witness for help | `gt mail send defender/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`defender/witness`) when:
...
```bash
gt mail send defender/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
